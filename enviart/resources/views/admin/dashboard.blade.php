              ...
              <div class="card ">
                <div class="card-body p-3">
                  <div class="row">
                    <div class="col-8">
                      <div class="numbers">
                        <p class="text-sm mb-0 text-capitalize font-weight-bold">  @if(session('type')==0)   कुल आइटम    @else Total Product @endif   </p>
                        <h5 class="font-weight-bolder mb-0">
              ...
              <div class="card ">
                <div class="card-body p-3">
                  <div class="row">
                    <div class="col-8">
                      <div class="numbers">
                        <p class="text-sm mb-0 text-capitalize font-weight-bold"> @if(session('type')==0) कुल चालान   @else Total Invoice @endif</p>
                        <h5 class="font-weight-bolder mb-0">
                          <?php echo count($user); ?>
                        </h5>
                      </div>
              ...
              <div class="card ">
                <div class="card-header pb-0 p-3">
                  <div class="d-flex justify-content-between">
                    <h6 class="mb-2">@if(session('type')==0)   ग्राहक का नाम    @else Customer Name @endif      </h6>
                  </div>
                </div>
                  ...
                  <table class="table table-flush" id="products-list">
                    <thead class="thead-light">
                        <tr> 
                          ...
                          <th>@if(session('type')==0) दिनांक                     @else date @endif                     </th>
                          <th>@if(session('type')==0) 
छाप                       @else Print @endif                          </th>
                        </tr>
                      </thead>
                    ...
                    ?>
                        <tr>
                          <td>
                            <div class="d-flex">
                              <h6 class="my-auto" style="white-space: break-spaces;">{{$customer_namevalue}}</h6>
                            </div>
                          </td>
