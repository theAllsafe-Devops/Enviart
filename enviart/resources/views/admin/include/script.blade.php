  ...
  <!-- Kanban scripts -->
  <script src="{{ URL::asset('public/assets/js/plugins/dragula/dragula.min.js') }}"></script>
  ...
  <script src="{{ URL::asset('public/assets/js/plugins/threejs.js') }}"></script>
  <script src="{{ URL::asset('public/assets/js/plugins/orbit-controls.js') }}"></script>
  <script>
