            ...
            <div class="card-header pb-0">
              <div class="d-lg-flex">
                <div class="ms-auto my-auto mt-lg-0 mt-4">
                  <h5 class="mb-0"> @if(session('type')==0)  सभी वस्तुएं   @else All Products  @endif</h5>
                  
                </div>
                <div class="@if(session('type')==0)    @else  ms-auto @endif my-auto mt-lg-0 mt-4">
                  <div class="ms-auto my-auto">
                    <a href="{{ url('admin/product/create') }}" class="btn bg-gradient-info btn-sm mb-0">+&nbsp;  @if(session('type')==0)  वस्तु का नाम    @else New Product  @endif</a>
...
क्रमांक  @else ID @endif</th>
                      <th> @if(session('type')==0)  वस्तु    @else Product @endif</th>
                      <th> @if(session('type')==0)  मूल्य    @else Price @endif</th>
                      <!--<th> @if(session('type')==0)  حالة    @else Status @endif</th>-->
                  ...
                  <tbody>@foreach($row as $key => $value)
                    <tr>
                      ...
                      <td>
                        <div class="d-flex">
                          <h6 class="ms-3 my-auto">{{$value->product_name}}</h6>
                        </div>
                      </td>
                      <td class="text-sm">
                      ...
                      <!--</td>-->
                      <td class="text-sm">
                        <a href="{{ url('admin/product/edit') }}/{{$value->id}}" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Edit product">
